...
h1$Global_reactive_power <- as.numeric(h1$Global_reactive_power)

par(mfrow = c(2,2))

plot(datetime, h1$Global_active_power, type="l", xlab = "", 
     ylab = "Global Active Power")
plot(datetime, h1$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(datetime, h1$Global_reactive_power, type="l", xlab = "datetime", 
